...
.then(data => {
  ...
  blueBanList.classList.add("list", `${Object.keys(bigData)[i]}`);
  bluePickList.classList.add("list", `${Object.keys(bigData)[i]}`);
  redBanList.classList.add("list", `${Object.keys(bigData)[i]}`);
  redPickList.classList.add("list", `${Object.keys(bigData)[i]}`);
  gameSet.classList.add("list", `${Object.keys(bigData)[i]}`);
